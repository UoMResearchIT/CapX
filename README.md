...
## Database Backups
The databases are backed up (including flusing of the WAL journals) as part of the deployment automation pipeline. However, there is also an hourly cronjob that flushes and backs up the DB to a different directory. This mechanism stores 48 backups, deleting the oldest when this file count is exceeded.
