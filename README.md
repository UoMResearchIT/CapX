...
CapX is currently deployed to [balex.itservices.manchester.ac.uk](balex.itservices.manchester.ac.uk). Access is restricted to Manchester IPs so will need to be on the VPN.
